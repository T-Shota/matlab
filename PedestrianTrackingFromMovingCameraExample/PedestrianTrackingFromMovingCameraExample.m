...
rosshutdown;
rosinit;
ptm_node = robotics.ros.Node('pedestrian_tracking_matlab1');
ptm_sub = robotics.ros.Subscriber(ptm_node, '/image_raw', 'sensor_msgs/Image', @PedestrianTrackingFromMovingCameraExample_ros);


function PedestrianTrackingFromMovingCameraExample_ros(~, msg)
...
% Create an empty array of tPedestrianTrackingFromMovingCameraExampleracks.
